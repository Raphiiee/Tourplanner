    ...
    public class Database : IDataAccess
    {
        ...
        public List<TourItem> GetItems()
        {
            ...
            return new List<TourItem>()
            {
                ...
                new TourItem() {TourId = 4, TourName = "Tour 3", Destination = "München",    Start = "Hollabrunn", Log = new ObservableCollection<LogItem>(){new LogItem(){Distance = 1112, Notice = "ABCD", Date = new DateTime(31/03/2000)}}},
